...
const config = {
  ...
  USER: {
    ...
    DEL_BABY: babyId => `${BASE_URL}/api/user/baby/${babyId}`, // 아기 정보 삭제
    MOD_BABY: babyId => `${BASE_URL}/api/user/baby/${babyId}`, // 아기 정보 수정
    BASIC_BABY: `${BASE_URL}/api/user/baby/basic`, // 아기 정보 등록
